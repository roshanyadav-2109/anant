      ...
      <section className="flex flex-col items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <button
            ...
            className="focus-ring mt-4 flex w-full items-center justify-center gap-2.5 rounded-[var(--radius)] bg-paper-raised py-2.5 text-[0.9375rem] font-[500] text-ink ring-1 ring-rule transition-colors hover:ring-ink-faint disabled:opacity-50"
          >
